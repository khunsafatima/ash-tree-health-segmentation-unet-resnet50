...
<p align="center"> <strong>Figure:</strong> The Workflow adopted for Tree Health Assessment using Deep Learning</p>
...
![An Example image displaying RGB image along with prediction-segmented image-using trained model](prediction.png)
...
If you would like to improve the framework, fix issues, or extend the methodology, please:
...
For substantial changes, please open an issue first to discuss the proposed improvements.

Please ensure that contributions:

- Follow consistent coding style
- Include clear documentation
- Do not include restricted or third-party data
